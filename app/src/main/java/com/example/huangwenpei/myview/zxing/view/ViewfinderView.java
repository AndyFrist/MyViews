 ...
 */
package com.example.huangwenpei.myview.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            maskColor = resources.getColor(R.color.transd, context.getTheme());
            resultColor = resources.getColor(R.color.blue_dark, context.getTheme());
            laserColor = resources.getColor(R.color.white, context.getTheme());
            resultPointColor = resources.getColor(R.color.white, context.getTheme());
        } else {
            maskColor = resources.getColor(R.color.transd);
            resultColor = resources.getColor(R.color.blue_dark);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            if (needDrawText) {
                ...
                StaticLayout layout = new StaticLayout("社么鬼文案", paint, width, Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, false);
