package com.example.huangwenpei.myview.zhifubao.adapter;
...
import com.example.huangwenpei.myview.Activity.MenuManageActivity;
...
public class MyAdapter extends BaseAdapter implements DragAdapterInterface {
	...
	public MyAdapter(MenuManageActivity context, MyApp appContext, List<MenuEntity> datas) {
